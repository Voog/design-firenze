...
<body class="blog-page content-page{% if fallback_state %} bgpicker-fallback{% endif %}">
  ...
  {% if body_bg_color != '' or editmode %}<div class="body-background-image js-body-background-image"></div>{% endif %}
