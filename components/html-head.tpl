...
{% stylesheet_link "main.min.css?v=firenze-2.3.0" %}
{% if editmode %}<link rel="stylesheet" href="{{ site.static_asset_host }}/libs/edicy-tools/latest/edicy-tools.css">{% endif %}
{% if editmode %}{% stylesheet_link "editmode.min.css?v=firenze-2.3.0" %}{% endif %}
...
<script src="{{ javascripts_path }}/modernizr-custom.min.js?v=firenze-2.3.0"></script>
