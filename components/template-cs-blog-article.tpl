:root {
  ...
  /* VoogStyle
     ...
     "scope": "global"
  */
  --content-submenu-line-height: 1.4;
  /* VoogStyle
    "pathI18n": ["blog", "tags", "normal"],
...
*/
  --content-submenu-hover-color: #444;
 /* VoogStyle
  "pathI18n": ["blog", "tags", "active"],
  "titleI18n": "color",
  "type": "button",
...
*/
  ...
  /* VoogStyle
    ...
    "featured": true
  */
  --blog-list-title-font-size: 36px;
  /* VoogStyle
     "pathI18n": ["blog", "title"],
     "titleI18n": "line_height",
     "editor": "rangePicker",
